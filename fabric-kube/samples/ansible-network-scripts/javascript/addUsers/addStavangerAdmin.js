...
async function main() {
    ...
    try {
        ...
        const credPath = path.join(fixtures, 'crypto-config/peerOrganizations/stavanger.no/users/Admin@stavanger.no');
        const certificate = fs.readFileSync(path.join(credPath, '/msp/signcerts/Admin@stavanger.no-cert.pem')).toString();
        ...
        const identityLabel = 'AdminStavanger';
